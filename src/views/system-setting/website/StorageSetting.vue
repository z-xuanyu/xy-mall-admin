 ...
 * @LastEditTime: 2022-03-16 15:51:02
      ...
      <div class="pl-20 mt-10" v-if="value === 2">
        <Form :model="formState" :label-col="labelCol" :wrapper-col="wrapperCol">
          ...
          <FormItem label="AccessKey ID">
            <Input placeholder="请输入AccessKey ID" v-model:value="formState.name" />
          </FormItem>
          <FormItem label="AccessKey Secret">
            <Input placeholder="请输入AccessKey Secret" v-model:value="formState.name" />
          </FormItem>
        </Form>
      </div>
